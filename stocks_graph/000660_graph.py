...
df = fd.DataReader('000660',start_date,end_date)
...
fig.update_layout(title='SK하이닉스 현재가: {:.2f} ( {:.2f}%)'.format(latest_price,price_change_percentage),xaxis_title='날짜',yaxis_title='주가')

html = 'C:/Users/ktf98/OneDrive/바탕 화면/웹프/G.I/SK하이닉스.html'
fig.write_html(html)
