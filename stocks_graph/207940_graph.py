...
df = fd.DataReader('207940',start_date,end_date)
...
fig.update_layout(title='삼성바이오로직스 현재가: {:.2f} ( {:.2f}%)'.format(latest_price,price_change_percentage),xaxis_title='날짜',yaxis_title='주가')

html = 'C:/Users/ktf98/OneDrive/바탕 화면/웹프/G.I/삼성바이오로직스.html'
fig.write_html(html)
